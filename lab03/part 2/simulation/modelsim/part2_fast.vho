...
-- Equation(s):
-- \stage7|HEX~0_combout\ = (\SW~combout\(0)) # ((\SW~combout\(2) & (!\SW~combout\(1))) # (!\SW~combout\(2) & ((\SW~combout\(3)))))
...
-- Equation(s):
-- \stage7|HEX~1_combout\ = ((\SW~combout\(0)) # (!\SW~combout\(2))) # (!\SW~combout\(3))
...
-- Equation(s):
-- \stage7|HEX[4]~2_combout\ = (\SW~combout\(3)) # ((\SW~combout\(1) & (\SW~combout\(0))) # (!\SW~combout\(1) & ((\SW~combout\(2)))))
...
-- Equation(s):
-- \stage7|HEX[3]~3_combout\ = (\SW~combout\(1) & (\SW~combout\(3) & \SW~combout\(2))) # (!\SW~combout\(1) & (\SW~combout\(3) $ (\SW~combout\(2))))
...
-- Equation(s):
-- \stage7|HEX~4_combout\ = (((\SW~combout\(0)) # (\SW~combout\(2))) # (!\SW~combout\(3))) # (!\SW~combout\(1))
...
-- Equation(s):
-- \stage7|HEX~5_combout\ = (\SW~combout\(1)) # ((\SW~combout\(3) & ((\SW~combout\(2)))) # (!\SW~combout\(3) & ((\SW~combout\(0)) # (!\SW~combout\(2)))))
