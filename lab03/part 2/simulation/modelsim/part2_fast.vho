...
SIGNAL \stage7|HEX[3]~4_combout\ : std_logic;
SIGNAL \stage7|HEX~5_combout\ : std_logic;
SIGNAL \SW~combout\ : std_logic_vector(0 TO 3);
SIGNAL \stage7|ALT_INV_HEX~5_combout\ : std_logic;
SIGNAL \stage7|ALT_INV_HEX[3]~3_combout\ : std_logic;
...
\stage7|ALT_INV_HEX[3]~3_combout\ <= NOT \stage7|HEX[3]~3_combout\;
...
-- Equation(s):
-- \stage7|HEX~0_combout\ = (\SW~combout\(0)) # (\SW~combout\(1) $ (\SW~combout\(2)))
...
-- Equation(s):
-- \stage7|HEX~1_combout\ = (\SW~combout\(1)) # (((\SW~combout\(0)) # (\SW~combout\(2))) # (!\SW~combout\(3)))
...
-- Equation(s):
-- \stage7|HEX[4]~2_combout\ = (\SW~combout\(0)) # ((\SW~combout\(1) & ((!\SW~combout\(2)))) # (!\SW~combout\(1) & ((\SW~combout\(3)) # (\SW~combout\(2)))))
...
-- Equation(s):
-- \stage7|HEX[3]~3_combout\ = \SW~combout\(1) $ (((!\SW~combout\(3) & (!\SW~combout\(0) & !\SW~combout\(2)))))
...
\stage7|HEX[3]~4\ : cycloneii_lcell_comb
-- Equation(s):
-- \stage7|HEX[3]~4_combout\ = (\SW~combout\(1) & (\SW~combout\(3) & (!\SW~combout\(0) & !\SW~combout\(2))))
...
PORT MAP (
	...
	datac => \SW~combout\(0),
	datad => \SW~combout\(2),
	combout => \stage7|HEX[3]~4_combout\);

-- Location: LCCOMB_X1_Y18_N26
\stage7|HEX~5\ : cycloneii_lcell_comb
-- Equation(s):
-- \stage7|HEX~5_combout\ = (\SW~combout\(0) & ((\SW~combout\(1)) # ((\SW~combout\(2))))) # (!\SW~combout\(0) & (\SW~combout\(1) $ (((!\SW~combout\(3) & !\SW~combout\(2))))))
...
-- pragma translate_on
PORT MAP (
	datain => \stage7|ALT_INV_HEX[3]~3_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	devoe => ww_devoe,
	oe => VCC,
